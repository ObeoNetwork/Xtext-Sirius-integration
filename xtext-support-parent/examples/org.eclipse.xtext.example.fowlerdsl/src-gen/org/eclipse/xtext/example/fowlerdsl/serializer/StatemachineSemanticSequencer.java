...
public class StatemachineSemanticSequencer extends XbaseSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (name=ID code=ID body=XBlockExpression?)
	 */
	...
	/**
	 * Constraint:
	 *     (importSection=XImportSection? events+=Event* resetEvents+=[Event|ID]* commands+=Command* states+=State*)
	 */
