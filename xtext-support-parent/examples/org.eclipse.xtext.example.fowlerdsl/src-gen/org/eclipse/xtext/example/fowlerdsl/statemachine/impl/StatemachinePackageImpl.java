...
public class StatemachinePackageImpl extends EPackageImpl implements StatemachinePackage
{
  ...
  public void initializePackageContents()
  {
		...
		getStatemachine_Events().getEKeys().add(this.getEvent_Code());
		...
		getStatemachine_ResetEvents().getEKeys().add(this.getEvent_Code());
		...
		getStatemachine_Commands().getEKeys().add(this.getCommand_Code());
		...
		getStatemachine_States().getEKeys().add(this.getState_Name());
