...
(
		{ 
	        newCompositeNode(grammarAccess.getStatemachineAccess().getImportSectionXImportSectionParserRuleCall_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getStatemachineAccess().getEventsKeyword_2_0());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getStatemachineAccess().getEndKeyword_2_2());
    }
)?(	otherlv_5='resetEvents' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getStatemachineAccess().getResetEventsKeyword_3_0());
    }
(
(
		{
	...
	otherlv_6=RULE_ID
	{
		newLeafNode(otherlv_6, grammarAccess.getStatemachineAccess().getResetEventsEventCrossReference_3_1_0()); 
	}

)
)+	otherlv_7='end' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getStatemachineAccess().getEndKeyword_3_2());
    }
)?(	otherlv_8='commands' 
    {
    	newLeafNode(otherlv_8, grammarAccess.getStatemachineAccess().getCommandsKeyword_4_0());
    }
(
(
		{ 
    ...
    {
    	newLeafNode(otherlv_10, grammarAccess.getStatemachineAccess().getEndKeyword_4_2());
    }
)?(
(
		{ 
...
(
		{ 
	        newCompositeNode(grammarAccess.getCommandAccess().getBodyXBlockExpressionParserRuleCall_2_0()); 
	    }
