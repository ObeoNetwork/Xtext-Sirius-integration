		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatemachineAccess().getImportSectionAssignment_1(), "rule__Statemachine__ImportSectionAssignment_1");
					...
					put(grammarAccess.getCommandAccess().getBodyAssignment_2(), "rule__Command__BodyAssignment_2");
